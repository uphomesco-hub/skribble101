...
export default function Lobby({
  ...
  players: Player[]
  isOwner: boolean
  onStart: (s: RoomSettings, order: string[], words: string[]) => void
}) {
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center justify-between">
            ...
            <select
              ...
              onChange={(e) => setSettings({ wordLength: parseInt(e.target.value) as any })}
          ...
          <div className="flex items-center justify-between">
            ...
            <input
              ...
              onChange={(e) => setSettings({ hints: e.target.checked })}
            />
          </div>
          <div>
            ...
            <textarea
              ...
              placeholder="e.g., jalebi, pune, cricket, chai"
              className="w-full h-24 rounded bg-slate-700 p-2"
            />
            <p className="text-xs text-slate-400 mt-1">
              We’ll mix these with the default word list.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="mt-4">
          <button
            ...
            onClick={() => {
              ...
              const words = [...EN_WORDS, ...settings.customWords]
